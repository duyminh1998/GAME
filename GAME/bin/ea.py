...
if __name__ == '__main__':
    ...
    if test == 0: # 3DMC test
        ...
        early_stop, early_stop_gen, early_stop_thresh, print_debug)
        # run the GAME model
        ea.evolve()
        ...
        # helper variables
        # transforming src data
        src_task_data_folder_and_filename = "11072022 3v2 RCS Sample Data Collection\\keepaway_3v2_transitions.csv"
        neural_networks_folder = "11072022 4v3 Neural Nets\\"
