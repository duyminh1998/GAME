...
save_agent = True
save_agent_every = 25
save_agent_folder = os.path.join(config_data["pickle_path"], "11112022 Train MC3D No Transfer")
...
save_eval_folder = os.path.join(config_data["output_path"], "11112022 Train MC3D No Transfer")
